...
// Todo:
// 1. Retrieve Task data from hooks into the copilotkit
// 2. Consider options for Clickup API metadata 
// 3. Test and leverage copilotkit hooks for task management
